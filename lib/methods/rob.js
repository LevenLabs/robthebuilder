    ...
    rpc.addMethod('Rob.RenderAndEmail', {
        handler: function(params, response) {
            ...
            if (!uniqueID) {
                ...
                // append a random number in case they don't want any dup prevention
                if (!params.dupThreshold) {
                    // after ^20 v8 starts to print in exponential notation
                    uniqueID += '' + (Math.random() * 1e20);
                }
            }
            if (uniqueID) {
