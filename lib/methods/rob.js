...
function buildParams(params, response) {
...
module.exports = function(rpc) {
    ...
    rpc.addMethod('Rob.Render', {
        handler: function(params, response) {
            callRender(params.name, buildParams(params.params, response), response).then(function(html) {
    ...
    rpc.addMethod('Rob.RenderAndEmail', {
        handler: function(params, response) {
            var user = response.get('user') || params.params.user || params.user,
                ...
                builtParams = buildParams(params.params, response),
